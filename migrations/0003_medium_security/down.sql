...
ALTER TABLE budget_period DROP CONSTRAINT IF EXISTS budget_period_user_id_name_key;
...
ALTER TABLE budget_period ADD CONSTRAINT budget_period_name_key UNIQUE (name);
